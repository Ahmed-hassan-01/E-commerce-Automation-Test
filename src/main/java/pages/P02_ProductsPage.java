...
public class P02_ProductsPage extends AbstractComponent {
    ...
    public void choosefilter(String filter) {
        ...
        Select dropdown = new Select(staticDropdown);
            switch (filter){
                case "AToZ":{dropdown.selectByIndex(0);break;}
                case "ZToA":{dropdown.selectByIndex(1);break;}
                case "LowToHigh":{dropdown.selectByIndex(2);break;}
                case "HighToLow":{dropdown.selectByIndex(3);break;}
            }
