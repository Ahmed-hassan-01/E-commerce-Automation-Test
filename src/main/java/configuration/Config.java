...
public class Config {
    ...
    String jsonPathValidCheckOutData = "\\src\\main\\resources\\validCheckOutData.json";
    String jsonPathInValidCheckOutDataSpecialCharacter = "\\src\\main\\resources\\invalidCheckOutDataSpecialCharacter.json";
    ...
    public String getJsonPath(String json) {
        ...
        switch (json) {
            ...
            case "validcheckOutData": {
                return jsonPathValidCheckOutData;
            }
            case "invalidcheckOutDataSpecialCharacter": {
                return jsonPathInValidCheckOutDataSpecialCharacter;
            }
