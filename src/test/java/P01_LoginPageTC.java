...
public class P01_LoginPageTC extends BaseTest {
    ...
    @BeforeMethod(groups = {"login", "smoke", "regression"})
    public void setup() {
    ...
    public void validUserNameAndPassword(HashMap<String, String> input) {
        ...
        LoginPage.submit();
        Assert.assertEquals(getDriver().getCurrentUrl(), input.get("afterLoginUrl"));
    }
    ...
    public void validUserNameAndemptyPassword(HashMap<String, String> input) {
        ...
        LoginPage.submit();
        Assert.assertEquals(getDriver().getCurrentUrl(), input.get("LoginUrl"));
